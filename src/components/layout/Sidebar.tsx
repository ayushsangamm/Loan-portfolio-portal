      ...
      `}>
        ...
        <div className="flex h-16 items-center justify-between px-6 border-b border-slate-800/40">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold tracking-tight text-white leading-tight">Antigravity</h1>
              <p className="text-[10px] font-medium text-slate-400 tracking-wider uppercase">Loan Systems</p>
            </div>
          </div>
        ...
        <div className="p-4 border-t border-slate-900 bg-slate-950/40">
          <div className="rounded-xl bg-slate-900/50 p-4 border border-slate-800/30">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[11px] font-semibold tracking-wider text-slate-400 uppercase">Gateway Online</span>
            </div>
            <p className="mt-1 text-[11px] text-slate-500 leading-normal">Operational Portal v3.4.1</p>
          </div>
        </div>
      </aside>
    </>
